...
import { getShareTo, getAddSocials, getHomePage, getSocialPage } from "@/lib/ShareCardArrays";
                ...
                >
                    {currentPage[currentPage.length - 1].page === "home" && <>
                        <div className="grid grid-cols-[32px_auto_32px] items-center p-3">
                            ...
                            <span className="font-semibold text-center">{t("share.share_your_linktre")}</span>
                        ...
                        <p className="text-sm opacity-50 px-3">{t("share.get_more_visitors")}</p>
